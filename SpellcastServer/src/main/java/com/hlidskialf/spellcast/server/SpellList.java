...
public class SpellList {
    ...
    public static final Spell MagicMirror = new Spell("Magic Mirror", "+C+W");
    ...
    public static final Spell LightningBolt2 = new Spell("Lightning Bolt", "WDD+C");
    ...
    public static final Spell FireStorm = new Spell("Fire Storm", "SWW+C");
    public static final Spell IceStorm = new Spell("Ice Storm", "WSS+C");
    ...
    public static final Spell Disease = new Spell("Disease", "DSFFF+C");
    public static final Spell Poison = new Spell("Poison", "DWWFWD");
    public static final Spell Blindness = new Spell("Blindness", "DWFF+D");
    public static final Spell Invisibility = new Spell("Invisibility", "PP+W+S");
    public static final Spell Haste = new Spell("Haste", "PWPWW+C");
